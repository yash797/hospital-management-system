...
function checkSchedule() {
    ...
    document.getElementById('patientName').value = `${patient.firstName} ${patient.middleName || ''} ${patient.lastName}`.trim();
    ...
    // Toggle visibility of divs based on the number of appointments
    document.getElementById('scheduleDetails').classList.remove('hidden');
...
// Hide schedule details and appointment form initially
document.getElementById('scheduleDetails').classList.add('hidden');
