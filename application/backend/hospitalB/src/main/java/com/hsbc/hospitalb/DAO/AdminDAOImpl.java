...
public class AdminDAOImpl implements AdminDAO {
    ...
    @Override
    public List<Appointment> getNextThreeDaysAppointmentsByDoctorId(long doctorId) {
        List<Appointment> appointments = new ArrayList<>();
        String query = sqlQueries.getProperty("getNextThreeDaysAppointmentsByDoctorId");;
        ...
        try (PreparedStatement stmt = connection.prepareStatement(query)) {
            ...
            stmt.setDate(3, Date.valueOf(threeDaysLater));
            ResultSet rs = stmt.executeQuery();
            while (rs.next()) {
                Appointment appointment = new Appointment(
                        rs.getInt("appointment_id"),
    ...
    private List<Schedule> getSchedulesByDoctorId(long doctorId) {
